...
mod1 <- lmer(log(CR.DF) ~ Month + (1|Animal.ID), data= NEOunmatched)
...
```{r}
NEOmod <- lmer(log(NEO.CR) ~ Month  + RelRank + (1 |Animal.ID), data= NEOunmatched)

#model diagnostics
vif(NEOmod)
plot(fitted(NEOmod), resid(NEOmod))
qqnorm(resid(NEOmod))

#model summary
summary(NEOmod) #month significant predictor of uNEO
AnovaNEO.Month <- Anova(NEOmod, type= "III")

#comparison to reduced model
NEOmod.red <- lmer(log(NEO.CR) ~ RelRank + (1 |Animal.ID), data= NEOunmatched)
anova(NEOmod, NEOmod.red, type= "III") #model including month sig better fit 
```
...
ggsave("~/Google Drive/Projects/Masters/rhesus-sociality-fGC-uNEO/Fig1.pdf", Fig2.Obj1.2, width= 174, height= 120, units= "mm", device=cairo_pdf)
```
...
ggsave("~/Google Drive/Projects/Masters/rhesus-sociality-fGC-uNEO/Fig2.pdf", Fig3.Obj2, width= 174, height= 100, units= "mm", device=cairo_pdf)
...
ggsave("~/Google Drive/Projects/Masters/rhesus-sociality-fGC-uNEO/Fig3.pdf", Fig4.Obj3, width= 174, height= 100, units= "mm", device=cairo_pdf)
```
